...
func TestReadConfig(t *testing.T) {
	...
	assert.Equal(t, server.JwtHeaders{
		CookieName:      "auth",
...
func TestReadFromEnv(t *testing.T) {
	...
	os.Setenv(prefix+"JWT_HEADERS_COOKIE_NAME", "jwt")
	os.Setenv(prefix+"JWT_HEADERS_COOKIE_TOKEN_NAME", "jwt_token")
	os.Setenv(prefix+"JWT_HEADERS_NICKNAME_CLAIM", "username")
